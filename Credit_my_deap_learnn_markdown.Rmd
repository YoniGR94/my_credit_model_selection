...
In order to check which method and models better, we will use the Credit data from ILSR package.
...
For simplicity of explanation, the best model is the linear model. and indeed, most models did not get any major improvement. Hoever, the NN model gave such a better performance, that I would recommend using it as well.
